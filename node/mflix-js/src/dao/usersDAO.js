...
export default class UsersDAO {
  static async injectDB(conn) {
    ...
    try {
      ...
      teste = await conn.db(process.env.MFLIX_NS).collection("teste")
    } catch (e) {
  ...
  */
  ...
  static async teste() {
    ...
    const bulkWriteResponse = await teste.bulkWrite(baseballPlayers)
  ...
  static async addUser(userInfo) {
    ...
    */
    try {
      ...
      // await sessions.insertOne({ user_id: userInfo.email})
      return { success: true }
    } catch (e) {
  ...
  static async getUserSession(email) {
    try {
      ...
      let r  = await sessions.findOne({ user_id: email })
      return r
    } catch (e) {
